<template>
  <div class="news">
    ...
    <div class="dynamic-page-heading">
      <video v-if="cms.newsBackgroundVideo" :key="cms.newsBackgroundVideo" playsinline autoplay muted loop
        :src="cms.newsBackgroundVideo" class="bg-media"></video>
      ...
      <div class="container heading-content">
        <div class="row">
          <div class="col-12 text-center">
            <h2 class="h1 text-white vmc-heading mb-0" style="text-shadow: 2px 2px 5px rgba(0,0,0,0.7);">
              NEWS & UPDATE
            </h2>
          </div>
        </div>
          ...
          <div class="row pt-4" v-if="(article.images && article.images.length > 0) || article.image">
            <div class="col-md-12 d-flex flex-column align-items-center">
              ...
              <template v-if="article.images && article.images.length > 0">
                <img v-for="(img, idx) in article.images" :key="'img-' + idx" :src="img"
              ...
              <template v-else-if="article.image">
                <img :src="article.image" class="img-fluid mb-4 shadow-sm"
                  style="max-height: 700px; border-radius: 8px; width: 100%; object-fit: contain; background: #f8f9fa;">
              </template>
