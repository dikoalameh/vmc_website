<template>
    <div class="vmc-login-form position-relative d-flex justify-content-center align-items-center vh-100 overflow-hidden">
        <div>
            <div class="login-box px-5 py-5 mt-2 position-relative bg-white d-flex flex-column justify-content-center align-items-center">
                
                <div class="login-container d-flex justify-content-center align-items-center mb-4">
                    <img :src="vmcLogo" alt="" style="width: 80px; margin-right: 15px;">
                ...
                <form @submit.prevent="handleLogin" class="w-100">
                    ...
                    <div class="vmc-input-box mx-auto my-4 position-relative">
                        ...
                        <input class="text-dark w-100 bg-transparent border-0" :type="showPassword ? 'text' : 'password'" v-model="password" required>
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        <button type="submit" class="text-white font-weight-bold vmc-bg-prime-4 border-0 p-2 text-uppercase">Login</button>
                    </div>
                    
                    <div class="vmc-remember-forgot mx-auto d-flex justify-content-between mt-4" style="max-width: 310px;">
                        <label class="d-flex">
                            <input type="checkbox">
