  ...
  <div>
    <div id="VMCKeyVisual" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active parallax-effect" :style="{ backgroundImage: 'url(' + banner12 + ')' }"
          id="BannerTwelve">
          ...
          <div class="container">
            <div class="carousel-caption text-left">
              ...
              <p class="vmc-text-white font-weight-light caption-three">
                One of the country’s pioneers in the maritime manning sector, Veritas Maritime Corp. welcomed on July
                11, 2019 its new leader, Francis Jerome “Jiro” Marquez, to family, friends and colleagues.
              </p>
            </div>
          </div>
        </div>
